...
export interface ApiCoreCore extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::core.core'> &
      Schema.Attribute.Private;
...
export interface ApiDoctorDoctor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    specialist: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiPatientPatient extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    DocumentType: Schema.Attribute.Enumeration<['CC', 'TI', 'RC']> &
      Schema.Attribute.Required;
    Email: Schema.Attribute.Email & Schema.Attribute.Required;
    LastName: Schema.Attribute.String &
      Schema.Attribute.Required &
      ...
      Schema.Attribute.DefaultTo<'last_name'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::patient.patient'
